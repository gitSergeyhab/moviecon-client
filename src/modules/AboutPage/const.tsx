...
результаты на странице профиля и странице статистики`,
  ...
  },
  {
    ...
    paragraphs: [
      `Промежуточные рассчитываются в конце каждого уровня`,
...
(mongodb). Также абсолютно бесплатно. Снова благодарности)`,
      `Некоторые картинки, использованные для дизайна, были скачаны
откуда непопадя, а также сгенерированы с помощью chatGPT и
DALLE.`,
      `Также с помощью chatGPT была создана часть этого описания (Реализация), текст на главной странице и
 часть запросов в mongodb. Да, снова спасибо, снова
бесплатно)`,
    ],
  },
];
